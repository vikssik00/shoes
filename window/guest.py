...
class ProductCard(QFrame):
    def __init__(self, product):
        ...
        # Подсветка (зеленый фон, если скидка > 15%)
...
class GuestWindow(QWidget):
    def __init__(self):
        ...
        main_layout.addWidget(btn_exit, alignment=Qt.AlignmentFlag.AlignRight)
    ...
    def logout(self):
        reply = QMessageBox.question(
            self,
            "Подтверждение",
            "Вы действительно хотите вернуться к окну авторизации?",
